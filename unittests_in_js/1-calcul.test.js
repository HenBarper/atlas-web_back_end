...
describe('SUM', () => {
  it('should return rounded sum for SUM', () => {
...
describe('SUBTRACT', () => {
  it('should return rounded difference for SUBTRACT', () => {
